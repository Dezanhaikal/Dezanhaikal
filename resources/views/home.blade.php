...
<div class="col-md-10">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('melihat.store') }}" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
               <table class="table table-bordered table-bordered" id="datatables">
                ...
                <button type="submit" class="btn btn-primary float-right btn-lg">KIRIM</button>
            </form>
            </div>
        </div>
</div>
